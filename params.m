classdef params
    properties (Constant)
        ...
        l_hat   = [0,  -2,  55*pi/180; 2.5,  -2,  35*pi/180; 22.5,  -2,  pi/2; 42.5, -2,  145*pi/180; 45, -2,  125*pi/180;
                   0,  32, -55*pi/180; 2.5,  32, -35*pi/180; 22.5,  32, -pi/2; 42.5, 32, -145*pi/180; 45, 32, -125*pi/180]'; % Camera Nominal State [x (m);y (m);theta (rad)]
