classdef sensorCalibrationParams < matlab.mixin.Copyable
    properties
        ...
        plotTime    = 2.5; % [sec] [0.5 default] [n*updateTime, n is interger] time interval to update plot
        ...
        epsilon_Lt  = deg2rad(10); % in rad
        epsilon_Lxy = 2.5; % in meter
        epsilon_P   = 0.1; % in meter
    ...
    methods
        function obj = sensorCalibrationParams()
            % =============================================================
