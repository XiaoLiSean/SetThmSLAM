...
helperPlotVehicle(carPose', pr.carDims, 0, 'Color', 'blue', 'DisplayName', 'mobile robot'); hold on;
...
set(h1,{'DisplayName'},{'nominal state $\hat{p}_{\theta}$'})
...
for i = 1:pr.n
    ...
    if i == 1
        ...
        set(h3,{'DisplayName'},{'nominal state $\hat{p}_{i}$ of $i^{th}$ marker'})
    else
