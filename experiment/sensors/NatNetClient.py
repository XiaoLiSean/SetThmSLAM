...
class NatNetClient:
    def __init__( self, serverIPAddress, localIPAddress):
    ...
    def __createDataSocket( self, port ):
        ...
        # In Unix System, this code won't work
        # Refer to: https://stackoverflow.com/questions/15734219/simple-python-udp-server-trouble-receiving-packets-from-clients-other-than-loca/15734249
        if platform.system() == 'Windows':
            result.bind( (self.localIPAddress, port) )
        else:
            # Case Unix system such as Raspi and Ubuntu
            result.bind( (str(socket.INADDR_ANY), port) )
